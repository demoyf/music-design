...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      filename: config.build.song_list,
    ...
    new HtmlWebpackPlugin({
      ...
      // necessary to consistently work with multiple chunks via CommonsChunkPlugin
      chunksSortMode: 'dependency',
      chunks: ['manifest','vendor','show_forum']
    }),
    new HtmlWebpackPlugin({
      filename: config.build.forum_page,
      ...
      // necessary to consistently work with multiple chunks via CommonsChunkPlugin
      chunksSortMode: 'dependency',
      chunks: ['manifest','vendor','forum_page']
    }),
    new HtmlWebpackPlugin({
    ...
    new HtmlWebpackPlugin({
      ...
      // necessary to consistently work with multiple chunks via CommonsChunkPlugin
      chunksSortMode: 'dependency',
      chunks: ['manifest','vendor','play_music']
    }),
    new HtmlWebpackPlugin({
      filename: config.build.search_result,
      ...
      // necessary to consistently work with multiple chunks via CommonsChunkPlugin
      chunksSortMode: 'dependency',
      chunks: ['manifest','vendor','search_result']
    }),
    new HtmlWebpackPlugin({
      filename: config.build.album_info,
      ...
      // necessary to consistently work with multiple chunks via CommonsChunkPlugin
      chunksSortMode: 'dependency',
      chunks: ['manifest','vendor','album_info']
    }),
    new HtmlWebpackPlugin({
      filename: config.build.artist,
      ...
      // necessary to consistently work with multiple chunks via CommonsChunkPlugin
      chunksSortMode: 'dependency',
      chunks: ['manifest','vendor','artist']
    }),
    new HtmlWebpackPlugin({
      filename: config.build.hot_artist,
      ...
      // necessary to consistently work with multiple chunks via CommonsChunkPlugin
      chunksSortMode: 'dependency',
      chunks: ['manifest','vendor','hot_artist']
    }),
    new HtmlWebpackPlugin({
      filename: config.build.billboard,
      ...
      // necessary to consistently work with multiple chunks via CommonsChunkPlugin
      chunksSortMode: 'dependency',
      chunks: ['manifest','vendor','billboard']
    }),
